...
browser: ['Fahrul Pushkontak','Safari','1.0.0'],
auth: state,
version
})
...
console.log(color(figlet.textSync(`Fahrul`, {
font: 'Standard',
...
if (anu.action == 'add') {
Zeltoria.relayMessage(anu.id, {
scheduledCallCreationMessage: {
callType: "AUDIO",
scheduledTimestampMs: 100,
title: `@${num.split("@")[0]}, Selamat Datang Di ${metadata.subject}, Semoga Betah Disini\nJangan Lupa Intro Biar Pada Kenal Dan Jangan Lupa Baca Deskripsi >,<\n`, 
}
}, {})
...
"businessOwnerJid": `6281916619735@s.whatsapp.net`
}
}, options)
